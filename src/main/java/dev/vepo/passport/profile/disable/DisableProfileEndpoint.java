package dev.vepo.passport.profile.disable;
...
@Path("/profiles/{profileId}/disable")
@ApplicationScoped
@RolesAllowed(RequiredRoles.ADMIN)
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public class DisableProfileEndpoint {
    private final ProfileRepository profileRepository;

    @Inject
    public DisableProfileEndpoint(ProfileRepository profileRepository) {
        this.profileRepository = profileRepository;
    }

    @POST
    @Transactional
    public ProfileResponse disable(@PathParam("profileId") long profileId) {
